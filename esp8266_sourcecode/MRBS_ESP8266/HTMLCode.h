		...
		<div class="main">
			<div class="login-top left">
				<form action="thanks" method="post" name="configForm" onsubmit="return checkValidDataSubmit()">
					...
					<input type="password" name="apPassword" id="apPassword" class="password" placeholder="AP Password - Default: don't use password"
					...
					<input type="password" name="staPassword" id="staPassword" class="password" placeholder="STA Password - Default: iaC3oocaeNasien3j"
